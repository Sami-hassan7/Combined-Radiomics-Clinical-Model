...
# clinical data path 
clc_data_path  = '/home1/p303924/MRI_umcg/Data/OPCdigits_333_split_t1good.csv'
...
ct_images = [os.path.join(path_to_data, x + '_t1.nii.gz') for x in files]
gtv_masks = [os.path.join(path_to_data, x + '_gtvtottot1.nii.gz') for x in files] # gtvpt or gtvtot
...
extractor.settings["binWidth"] = 5 # look at papers            # try smaller value like (0.05, 0.1)
extractor.settings["resampledPixelSpacing"] = (0.5, 0.5, 3.0)  # try (1.0, 1.0, 1.0)
...
print (all_features)
all_features.to_csv('/home1/p303924/MRI_umcg/radiomics/' + 'umcg_radiomicsfeature_t1_GTVtot.csv' ) 
